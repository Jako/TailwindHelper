...
switch ($options[xPDOTransport::PACKAGE_ACTION]) {
    case xPDOTransport::ACTION_INSTALL:
        $output .= '<h2>Install TailwindHelper</h2>

        <p>Thanks for installing TailwindHelper. This open source extra was
    ...
    case xPDOTransport::ACTION_UPGRADE:
        $output .= '<h2>Upgrade TailwindHelper</h2>

        <p>TailwindHelper will be upgraded. This open source extra was developped by
